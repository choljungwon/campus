...
<script>
    ...
    */
    ...
    {      
       var params = {
               ...
               content : key            ,
               from    : 'ghddhfn1858@naver.com'   , // 관리자 
               to      : email      , // 사용자 
               type    : 'findpwd'
   ...
   // 실시간으로 남은 시간 보여 주는 함수 
    /*
        dt :datetime ,
        id : control ID
        재귀함수: 함수안에 함수  무한로프 도는 함수 안에 있는 함수을 재귀함수 
    */
    var timer;
    function CountDownTimer(dt, id) {
       ...
       // var timer;
        ...
        timer = setInterval(showRemaining, 1000); // 1초마다 showRemaining 함수 계속 호출 호출후 함수명을 리턴 
    }
       ...
       var params = {
         ...
         $
               .ajax({
                  ...
                  success : function(res) {
                   clearInterval(timer); // 타이머 중지 함수명 호출한걸 해제
